...
def redraw_window(win, board, strikes,button):
    win.fill((0,0,0))
    # Draw Strikes
    fnt = pygame.font.SysFont("comicsans", 40)
    text = fnt.render("X " * strikes, 1, (0, 255, 255))
    win.blit(text, (20, 560))
    # Draw grid and board
    board.draw(win)
    #draw button
    # text = fnt.render("START", 1, (255,255,255))
    # win.blit(text, (590, 255))
    win.blit(button.image, (button.rect.x, button.rect.y))
...
def main():
    ...
    start_button = Button(590, 255, start_img, 0.35)
    ...
    while run:
        ...
        redraw_window(win, board, strikes,start_button)
